...
Numba-accelerated Python library for simulating 2D Lagrangian particle transport in idealized semi-enclosed ocean basins using Bell's incompressible flow.
